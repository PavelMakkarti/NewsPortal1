    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postAuthor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='New.author')),
            ],
        ),
        migrations.CreateModel(
            name='PostCategory',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('postCategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='New.category')),
                ('postPost', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='New.post')),
            ],
        ),
        migrations.AddField(
            model_name='post',
